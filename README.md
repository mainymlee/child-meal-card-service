...
- 메뉴·가격은 공식 메뉴판 데이터가 아니다. 가게명·등록 업종으로 판단 가능한 곳만 예상 메뉴를 표시하고, 판단하기 어려운 곳은 추천에서 제외한다.
...
기존 좌표를 유지하면서 메뉴 분류 규칙만 다시 적용하려면 다음 명령을 사용합니다.
...
- [오늘까지의 개발 현황](docs/개발현황_20260818.md)
- [기술 고도화 로드맵](docs/기술고도화_로드맵.md)
- [메뉴추천 AI v2 개발 기획서](docs/메뉴추천AI_v2_개발기획서.md)
- [챗봇·메뉴추천 AI 구조](docs/개발구조_챗봇_메뉴추천AI.md)
- [서비스 기획서](docs/결식아동_급식카드_기획서_개정1_20260814본.md)
